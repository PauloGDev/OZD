...
const Header = () => {
    ...
    return (
        <div className="z-20 fixed top-0 left-0 w-full py-5 max-w-[100vw]">
                ...
                <div className="flex justify-between relative">
                    ...
                    <div>
                        <ul className="flex space-x-2">
                            ...
                            <li className="list-none inline-block">
                                {/* Nav Menu Toggle */}
                                <button type="button" onClick={toggleMenu} className="inline-block relative z-[1] overflow-hidden cursor-pointer group px-5 py-2.5 pr-[34px] bg-white text-black font-outfit rounded-3xl uppercase text-xs md:text-sm font-medium tracking-wider after:content-[''] after:absolute after:top-1/2 after:right-[20px] after:-translate-y-1/2 after:bg-black after:w-[5px] after:h-[5px] after:rounded-full after:transition-all after:duration-[60ms] hover:after:opacity-40 hover:after:scale-[2.7] cursor-link">
